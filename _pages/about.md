...
<img src="{{ base_path }}/images/system.png" alt="Holistic System Hierarchy" style="max-width: 90%; height: auto;">
</div>
...
IEEE International Conference on Solid-State Circuits (**ISSCC**), **2026** (to appear) <span style="background-color: #ff9800; color: white; padding: 2px 8px; border-radius: 3px; font-size: 0.85em; font-weight: bold;">Top-Tier</span> <span style="background-color: #17a2b8; color: white; padding: 2px 8px; border-radius: 3px; font-size: 0.85em; font-weight: bold;">Circuit</span>
